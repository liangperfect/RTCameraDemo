...
public class MagicFilterCool extends MagicFilterDefault {
    ...
    public void onInit() {
        super.onInit();
        mToneCurveTextureUniformLocation = GLES20.glGetUniformLocation(mProgramHandle, "curve");
        onInitialized();
    }
